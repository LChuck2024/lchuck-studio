  ...
  return (
    <BrowserRouter>
      ...
      <div className="w-full min-h-screen overflow-x-hidden relative">
        ...
        {/* 页面内容 - 带淡入淡出动画（body 滚动，PhysicsSystem 依赖 window.scrollY） */}
        <AnimatedRoutes />
        ...
        <div className="fixed top-3 sm:top-6 md:top-10 left-4 right-4 sm:left-6 sm:right-auto md:left-10 z-[100] pointer-events-none px-2">
          <div className="flex flex-col items-center gap-3 md:flex-row md:items-center md:gap-12 lg:gap-16">
            {/* 标题部分 */}
            <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 text-xs sm:text-[1.2vw] md:text-[9px] font-mono text-gray-400 font-bold tracking-[0.3em] uppercase">
        ...
        {/* 底部左侧 HUD - 移动端隐藏避免重叠 */}
        <div className="hidden sm:block fixed bottom-6 md:bottom-10 left-6 md:left-10 z-[100] pointer-events-none font-mono text-[10px] sm:text-[1.2vw] md:text-[9px] text-gray-400 space-y-1.5 uppercase tracking-widest">
        ...
        {/* 底部右侧 HUD - 移动端隐藏避免重叠 */}
        <div className="hidden sm:block fixed bottom-6 md:bottom-10 right-6 md:right-10 z-[100] pointer-events-none font-mono text-[10px] sm:text-[1.2vw] md:text-[9px] text-gray-400 text-right uppercase tracking-widest leading-relaxed">
