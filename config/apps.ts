    ...
    cards: [
      {
        icon: '🤖',
        index: '01',
        title: 'Enterprise Agentic RAG Framework',
        ...
        cta: { type: 'link', label: 'Execute Live Demo', message: '', href: 'https://ai-rag-pro.streamlit.app', action: 'link' },
      },
      {
        icon: '🏗️',
        index: '02',
        title: 'CDC Architecture Consulting',
        ...
        cta: { type: 'primary', label: 'Architecture Details', roleId: 'data-architect', message: '我想了解 CDC 架构咨询的流程与架构详情。', action: 'chatbot' },
      },
      {
        icon: '🗄️',
        index: '03',
        ...
        cta: { type: 'primary', label: 'Architecture Details', roleId: 'data-architect', message: '我想了解主数据治理与 MDM 落地的架构详情。', action: 'chatbot' },
      },
      {
        icon: '📦',
        index: '04',
        title: 'Data Quality As-a-Service',
        ...
        cta: { type: 'primary', label: 'Request Access', roleId: 'data-architect', message: '我想了解数据清洗代办的架构与交付流程。', action: 'chatbot' },
      },
    ],
  },
  {
    ...
    cards: [
      {
        icon: '🇪🇺',
        index: '01',
        title: 'European Open University Course Finder',
        subtitle: '非结构化数据标准化治理案例',
        desc: '基于主数据清洗与分级建模架构，将 270+ 门碎裂的课程信息重构为高价值数据模型。实现学科/学费/学分的多维度筛选与标准化治理，证明主数据管理（MDM）能力的实战落地。',
        tech: 'MDM · 主数据清洗 · 分级建模',
        cta: { type: 'link', label: 'Launch Prototype', message: '', href: 'https://web.wps.cn/wo/sl/v31rzbsD?app_id=1PKY0UiCwcIPzRKjh3CoI6', action: 'link' },
      },
      {
        icon: '📱',
        index: '02',
        title: 'Xiaohongshu Content Optimization Engine',
        ...
        cta: { type: 'primary', label: 'Request Access', roleId: 'solo-preneur', message: '我想申请访问小红书笔记增长引擎。', action: 'chatbot' },
      },
      {
        icon: '🧠',
        index: '03',
        title: 'P0-Driven Strategy OS',
        ...
        cta: { type: 'primary', label: 'Request Access', roleId: 'solo-preneur', message: '我想申请访问 P0-Driven Strategy OS。', action: 'chatbot' },
      },
    ],
  },
  {
    ...
    cards: [
      {
        icon: '🧹',
        index: '01',
        title: 'RAG Data Ops Infrastructure',
        ...
        cta: { type: 'primary', label: 'Request Access', roleId: 'data-architect', message: '我想申请访问 RAG Data Ops Infrastructure。', action: 'chatbot' },
      },
      {
        icon: '⚙️',
        index: '02',
        title: 'Enterprise Narrative Engine',
        ...
        cta: { type: 'primary', label: 'Request Access', roleId: 'data-architect', message: '我想申请访问 Enterprise Narrative Engine。', action: 'chatbot' },
      },
      {
        icon: '🦞',
        index: '03',
        title: 'OpenClaw Agent Deployment Package',
        ...
        cta: { type: 'outline', label: 'Architecture Details', message: '我想了解 OpenClaw 智能体部署包的架构与演示。', action: 'chatbot' },
      },
    ],
  },
];
